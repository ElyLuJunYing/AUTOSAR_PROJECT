 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_Test_SWC2_Read_Element(uint8 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_Test_SWC2_Rte_Read_Test_SWC2_Read_Element(&Read_Test_SWC2_Read_Element);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Test_SWC2_Rte_Write_Test_SWC2_Write_Element(Rte_InitValue_Test_SWC2_Write_Element);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
