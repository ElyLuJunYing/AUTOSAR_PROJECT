...
{
  return Rte_Read_RearLeftWindowPosition_u8_Signal(data);
}

Std_ReturnType TSC_CtLedTask_Rte_Read_RearRightWindowPosition_u8_Signal(uint8 *data)
{
  return Rte_Read_RearRightWindowPosition_u8_Signal(data);
}
...
{
  return Rte_Write_RearInteriorLight_Bool_Siganl(data);
}
