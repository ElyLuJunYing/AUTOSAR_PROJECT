...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_TEST_SWC_APPL)  ******************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Test_SWC_CONST)  *********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Test_SWC_VAR)  ***********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Test_SWC_CODE)  **********************/
